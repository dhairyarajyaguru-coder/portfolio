...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const roles = ["BCA Graduate", "Python Developer", "Web Developer", "Cybersecurity Enthusiast"];
    let roleIndex = 0;
    let charIndex = 0;
    ...
    contactForm.addEventListener('submit', (e) => {
        ...
        if (isValid) {
            ...
            submitBtn.innerHTML = `<span>Sending...</span> <i data-lucide="loader" class="btn-icon animate-spin"></i>`;
            lucide.createIcons();
